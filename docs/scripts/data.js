class DATA {
  constructor() {
    this.rawNumbers = `72,86,73,66,37,76,19,40,77,42,48,62,46,3,95,17,97,41,10,14,83,90,12,23,81,98,11,57,13,69,28,63,5,78,79,58,54,67,60,34,39,84,94,29,20,0,24,38,43,51,64,18,27,52,47,74,59,22,85,65,80,2,99,70,33,91,53,93,9,82,8,50,7,56,30,36,89,71,21,49,31,88,26,96,16,1,75,87,6,61,4,68,32,25,55,44,15,45,92,35`;

    this.rawBoards = `58 60 65  4 91
73 31 80 83 44
98 47 33 21 25
76  6 41 94 50
55 30 52 11 36
...
87 45 17 93 62`;
  ...
  initNumbers() {
    this.loto = this.rawNumbers.split(",").map(Number);
